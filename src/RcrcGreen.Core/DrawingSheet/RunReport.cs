...
namespace RcrcGreen.Core
{
    ...
    public static class RunReport
    {
        ...
        private static void Closing(StringBuilder report)
        {
            ...
            Line(report, "plot and remembered per model, never read off the model's own numbers,");
            Line(report, "which are copies on every plot but one. Name and number can both be");
